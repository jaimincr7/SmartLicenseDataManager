...
class SqlServerOverridesService {
  ...
  public async searchSqlServerOverrides(
    searchParams?: ISearchSqlServerOverrides
  ): Promise<IApiResponse<ISearchResponse<ISqlServerOverrides>>> {
  ...
  public async saveSqlServerOverrides(data: ISqlServerOverrides): Promise<any> {
...
export default new SqlServerOverridesService();
