  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('tenant_id', (azureDailyUsage.search.lookups?.tenants?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('company_id', (azureDailyUsage.search.lookups?.companies?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('bu_id', (azureDailyUsage.search.lookups?.bus?.length > 0 ?
