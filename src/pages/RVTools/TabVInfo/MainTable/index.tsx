  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('tenant_id', (tabVInfo.search.lookups?.tenants?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('company_id', (tabVInfo.search.lookups?.compaanies?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('bu_id',(tabVInfo.search.lookups?.bus?.length > 0 ?
