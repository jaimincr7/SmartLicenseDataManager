  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('tenant_id', (o365MailboxUsage.search.lookups?.tenants?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('company_id', (o365MailboxUsage.search.lookups?.companies?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('bu_id', (o365MailboxUsage.search.lookups?.bus?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDateSwapTable('created_date', o365MailboxUsage.search.tableName, form),
