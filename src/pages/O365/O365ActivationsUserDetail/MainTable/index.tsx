  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('tenant_id', (o365ActivationsUserDetail.search.lookups?.tenants?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('bu_id', (o365ActivationsUserDetail.search.lookups?.bus?.length > 0 ?
