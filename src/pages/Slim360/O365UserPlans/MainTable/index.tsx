...
const MainTable: React.ForwardRefRenderFunction<unknown, IMainTable> = (props, ref) => {
  ...
  const FilterBySwap = (dataIndex: string, form) => {
    return FilterWithSwapOption(dataIndex, slim360O365UserPlans.search.tableName, form);
  };
  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('tenant_id', slim360O365UserPlans.search.lookups?.tenants),
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('company_id', slim360O365UserPlans.search.lookups?.companies),
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('bu_id', slim360O365UserPlans.search.lookups?.bus),
            dataIndex: 'bu_name',
            key: 'bu_name',
            ellipsis: true,
          },
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDateSwap('date_added', slim360O365UserPlans.search.tableName, form),
  ...
  const tableAction = (_, data: any) => (
    <div className="btns-block">
      ...
      <Can I={Action.Delete} a={Page.Slim360O365UserPlans}>
        <Popconfirm title="Sure to delete?" onConfirm={() => removeSlim360O365UserPlans(data.id)}>
