...
import { IConfigOnlineProductsProps } from './onlineProducts.model';
...
import AddConfigOnlineProductsModal from './AddOnlineProductsModal';
import {
  clearConfigOnlineProducts,
  configOnlineProductsSelector,
} from '../../../store/master/onlineProducts/onlineProducts.reducer';

const ConfigOnlineProducts: React.FC<IConfigOnlineProductsProps> = (props) => {
  ...
  return (
    <div className="sqlServer">
      <div className="title-block">
        <h4 className="p-0">
          <BreadCrumbs pageName={Page.ConfigOnlineProducts} />
        </h4>
      </div>
      ...
      {deleteModalVisible && (
        <DeleteDatasetModal
          ...
          tableName={configOnlineProducts.search.tableName}
          refreshDataTable={() => refreshDataTable()}
        />
      )}
    </div>
...
export default ConfigOnlineProducts;
