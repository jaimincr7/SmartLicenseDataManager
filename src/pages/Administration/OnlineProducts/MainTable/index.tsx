...
const MainTable: React.ForwardRefRenderFunction<unknown, IMainTable> = (props, ref) => {
  ...
  const FilterBySwap = (dataIndex: string, form) => {
    return FilterWithSwapOption(dataIndex, configOnlineProducts.search.tableName, form);
  };
  ...
  const tableAction = (_, data: any) => (
    <div className="btns-block">
      ...
      <Can I={Action.Delete} a={Page.ConfigOnlineProducts}>
        <Popconfirm title="Sure to delete?" onConfirm={() => removeConfigOnlineProducts(data.id)}>
