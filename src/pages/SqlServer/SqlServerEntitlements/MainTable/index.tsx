  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('tenant_id', (sqlServerEntitlements.search.lookups?.tenants?.length > 0 ?
              sqlServerEntitlements.search.lookups?.tenants :
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('company_id', (sqlServerEntitlements.search.lookups?.companies?.length > 0 ?
              sqlServerEntitlements.search.lookups?.companies :
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('bu_id', (sqlServerEntitlements.search.lookups?.bus?.length > 0 ?
              sqlServerEntitlements.search.lookups?.bus :
