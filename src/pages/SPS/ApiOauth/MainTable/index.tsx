...
const MainTable: React.ForwardRefRenderFunction<unknown, IMainTable> = (props, ref) => {
  ...
  const FilterBySwap = (dataIndex: string, form) => {
    return FilterWithSwapOption(dataIndex, spsApiOauth.search.tableName, form);
  };
  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('consent', spsApiOauth.search.lookups?.booleanLookup),
            dataIndex: 'consent',
            key: 'consent',
            ellipsis: true,
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('active', spsApiOauth.search.lookups?.booleanLookup),
            dataIndex: 'active',
            key: 'active',
            ellipsis: true,
            render: (value: boolean) => (!_.isNull(value) ? (value ? 'Yes' : 'No') : ''),
  ...
  const tableAction = (_, data: any) => (
    <div className="btns-block">
      ...
      <Can I={Action.Delete} a={Page.SpsApiOauth}>
        <Popconfirm title="Sure to delete?" onConfirm={() => removeSpsApiOauth(data.id)}>
