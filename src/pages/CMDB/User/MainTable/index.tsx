...
const MainTable: React.ForwardRefRenderFunction<unknown, IMainTable> = (props, ref) => {
  ...
  const FilterBySwap = (dataIndex: string, form) => {
    return FilterWithSwapOption(dataIndex, cmdbUser.search.tableName, form);
  };
  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('is_service_account', cmdbUser.search.lookups?.booleanLookup),
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('is_resource', cmdbUser.search.lookups?.booleanLookup),
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('in_active_directory', cmdbUser.search.lookups?.booleanLookup),
  ...
  const tableAction = (_, data: any) => (
    <div className="btns-block">
      ...
      <Can I={Action.Delete} a={Page.CmdbUser}>
        <Popconfirm title="Sure to delete?" onConfirm={() => removeCmdbUser(data.id)}>
