...
const MainTable: React.ForwardRefRenderFunction<unknown, IMainTable> = (props, ref) => {
  ...
  const FilterBySwap = (dataIndex: string, form) => {
    return FilterWithSwapOption(dataIndex, cmdbVirtualization.search.tableName, form);
  };
  ...
  const getTableColumns = (form) => {
    return [
      ...
      {
        title: <span className="dragHandler">Data Center Name</span>,
      ...
      {
        title: <span className="dragHandler">Data Center Id</span>,
        column: 'DataCenterId',
        sorter: true,
        children: [
          {
  ...
  const tableAction = (_, data: any) => (
    <div className="btns-block">
      ...
      <Can I={Action.Delete} a={Page.CmdbVirtualization}>
        <Popconfirm title="Sure to delete?" onConfirm={() => removeCmdbVirtualization(data.id)}>
