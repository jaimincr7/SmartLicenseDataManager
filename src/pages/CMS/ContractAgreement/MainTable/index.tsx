  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('tenant_id', cmsContractAgreement.search.lookups?.tenants),
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('company_id', cmsContractAgreement.search.lookups?.companies),
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('bu_id', cmsContractAgreement.search.lookups?.bus),
            dataIndex: 'bu_name',
            key: 'bu_name',
            ellipsis: true,
          },
  ...
  const tableAction = (_, data: any) => (
    <div className="btns-block">
      ...
      <Can I={Action.Delete} a={Page.CmsContractAgreement}>
        <Popconfirm title="Sure to delete?" onConfirm={() => removeCmsContractAgreement(data.id)}>
