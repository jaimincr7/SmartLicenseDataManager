...
import { ICmsPurchaseProps } from './purchase.model';
...
import AddCmsPurchaseModal from './AddPurchaseModal';
...
const CmsPurchase: React.FC<ICmsPurchaseProps> = (props) => {
  ...
  return (
    <div className="sqlServer">
      <div className="title-block">
        <h4 className="p-0">
          <BreadCrumbs pageName={Page.CmsPurchase} />
        </h4>
