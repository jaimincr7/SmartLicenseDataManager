  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('tenant_id', (cmsPurchase.search.lookups?.tenants?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('company_id', (cmsPurchase.search.lookups?.companies?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('bu_id', (cmsPurchase.search.lookups?.bus?.length > 0 ?
