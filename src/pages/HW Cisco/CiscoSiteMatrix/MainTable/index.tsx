  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('tenant_id',(ciscoSiteMatrix.search.lookups?.tenants?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('company_id',(ciscoSiteMatrix.search.lookups?.companies?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('bu_id',(ciscoSiteMatrix.search.lookups?.bus?.length > 0 ?
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDateSwap('date_added', ciscoSiteMatrix.search.tableName, form),
