...
const MainTable: React.ForwardRefRenderFunction<unknown, IMainTable> = (props, ref) => {
  ...
  const FilterBySwap = (dataIndex: string, form) => {
    return FilterWithSwapOption(dataIndex, ciscoSpectrum.search.tableName, form);
  };
  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('tenant_id', ciscoSpectrum.search.lookups?.tenants),
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('company_id', ciscoSpectrum.search.lookups?.companies),
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('bu_id', ciscoSpectrum.search.lookups?.bus),
            dataIndex: 'bu_name',
            key: 'bu_name',
            ellipsis: true,
          },
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDateSwap('date_added', ciscoSpectrum.search.tableName, form),
  ...
  const tableAction = (_, data: any) => (
    <div className="btns-block">
      ...
      <Can I={Action.Delete} a={Page.HwCiscoSpectrum}>
        <Popconfirm title="Sure to delete?" onConfirm={() => removeCiscoSpectrum(data.id)}>
