  ...
  const getTableColumns = (form) => {
    return [
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('tenant_id', ciscoProductAttributes.search.lookups?.tenants),
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('company_id', ciscoProductAttributes.search.lookups?.companies),
      ...
      },
      {
        ...
        children: [
          {
            title: FilterByDropdown('bu_id', ciscoProductAttributes.search.lookups?.bus),
            dataIndex: 'bu_name',
            key: 'bu_name',
            ellipsis: true,
          },
      ...
      {
        title: <span className="dragHandler">Product SubType</span>,
      ...
      {
        title: <span className="dragHandler">Architecture SubGroup</span>,
  ...
  const tableAction = (_, data: any) => (
    <div className="btns-block">
      ...
      <Can I={Action.Delete} a={Page.HwCiscoProductAttributes}>
        <Popconfirm title="Sure to delete?" onConfirm={() => removeCiscoProductAttributes(data.id)}>
