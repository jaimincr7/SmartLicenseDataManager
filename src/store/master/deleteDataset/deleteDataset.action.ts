import { IDeleteDataset, ISearchDeleteDataset } from '../../../services/master/deleteDataset/deleteDataset.model';
import { createAsyncThunk } from '@reduxjs/toolkit';
import DeleteDatasetService from '../../../services/master/deleteDataset/deleteDataset.service';

// Asynchronous thunk action

export const searchDeleteDataset = createAsyncThunk('searchDeleteDataset', async (searchParam?: ISearchDeleteDataset) => {
...
export const saveDeleteDataset = createAsyncThunk('saveDeleteDataset', async (data: IDeleteDataset) => {
