...
export const searchAdDevicesExclusions = createAsyncThunk(
  ...
  async (searchParam?: ISearchAdDevicesExclusions) => {
    const response = await adDevicesExclusionsService.searchAdDevicesExclusions(searchParam).then((res) => {
      return res.body;
    });
...
export const getAdDevicesExclusionsById = createAsyncThunk('getAdDevicesExclusionsById', async (id: number) => {
...
export const saveAdDevicesExclusions = createAsyncThunk('saveAdDevicesExclusions', async (data: IAdDevicesExclusions) => {
...
export const deleteAdDevicesExclusions = createAsyncThunk('deleteAdDevicesExclusions', async (id: number) => {
